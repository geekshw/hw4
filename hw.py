...
# bot = Bot(token="7289091146:AAFdPO4SEPwPk-t_1J-QnlU2vMyglApEiDY")
# dp = Dispatcher(bot)
...
#     await message.reply("Мы одна из самых популярных магазинов техники у нас есть магазины в Оше, и Бишкеке")
